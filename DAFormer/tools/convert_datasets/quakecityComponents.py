...
def parse_args():
    parser = argparse.ArgumentParser(
        description='Convert QuakeCity annotations to TrainIds')
    parser.add_argument('quakecity_path', help='quake data path')
...
def main():
    args = parse_args()
    quakecity_path = args.quakecity_path
    out_dir = args.out_dir if args.out_dir else quakecity_path
    mmcv.mkdir_or_exist(out_dir)

    gt_dir = osp.join(quakecity_path, args.gt_dir)
