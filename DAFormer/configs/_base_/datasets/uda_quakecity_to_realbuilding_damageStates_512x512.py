...
# dataset settings
dataset_type = 'RealBuildingDatasetDamageStates'
data_root = '../data/realbuildingDamageStates/'
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        type='UDADataset',
        source=dict(
            type='QuakeCityDatasetDamageStates',
            data_root='../data/quakecityDamageStates/',
            img_dir='images',
            ann_dir='labels',
            pipeline=quakecity_train_pipeline),
        target=dict(
            type='RealBuildingDatasetDamageStates',
            data_root='../data/realbuildingDamageStates/',
