...
_base_ = [
    ...
    '../_base_/models/daformer_sepaspp_mitb5_damageStateClassification.py',
    # QuakeCity->RealBuilding Data Loading
    '../_base_/datasets/uda_quakecity_to_realbuilding_damageStates_512x512.py',
...
use_sed_labels = False


evaluation = dict(interval=5000, metric='mIoU')
# Meta Information for Result Analysis
name = 'DAFormer_damageStateClassification'
exp = 'basic'
